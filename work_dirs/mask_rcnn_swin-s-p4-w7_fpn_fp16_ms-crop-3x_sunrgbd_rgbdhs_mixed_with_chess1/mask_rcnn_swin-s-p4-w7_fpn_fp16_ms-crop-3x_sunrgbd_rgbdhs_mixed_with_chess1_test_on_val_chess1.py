...
data = dict(
    ...
    train=dict(
        type='CocoDataset',
        ann_file=
        '/data/sophia/a/Xiaoke.Shen54/DATASET/sunrgbd_DO_NOT_DELETE/train/gts/raw_gts/det_train_rgb_and_dhs_with_chess1.json',
        img_prefix=
...
work_dir = './work_dirs/mask_rcnn_swin-s-p4-w7_fpn_fp16_ms-crop-3x_sunrgbd_rgbdhs_mixed_with_chess1'
gpu_ids = range(0, 1)
