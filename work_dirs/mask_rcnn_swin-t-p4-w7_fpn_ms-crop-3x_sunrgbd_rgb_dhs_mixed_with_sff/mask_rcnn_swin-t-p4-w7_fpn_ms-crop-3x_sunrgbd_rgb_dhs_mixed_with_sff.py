...
data = dict(
    ...
    train=dict(
        type='CocoDataset',
        ann_file=
        '/data/sophia/a/Xiaoke.Shen54/DATASET/sunrgbd_DO_NOT_DELETE/train/gts/raw_gts/det_train_rgb_and_dhs_with_sff.json',
        img_prefix=
...
resume_from = None
workflow = [('train', 1)]
work_dir = './work_dirs/mask_rcnn_swin-t-p4-w7_fpn_ms-crop-3x_sunrgbd_rgb_dhs_mixed_with_sff'
gpu_ids = range(0, 1)
